...
public class SpecialDayUtil {
    ...
    private static com.shixi.shixitraining.shixitraining.util.SpecialDayUtil mSpecailDay;
    ...
    public static com.shixi.shixitraining.shixitraining.util.SpecialDayUtil getInstance() {
        if (mSpecailDay == null) {
            mSpecailDay = new com.shixi.shixitraining.shixitraining.util.SpecialDayUtil();
        }
        return mSpecailDay;
    }
    ...
    public String getHolidayName(Calendar calendar) {
        ...
        if (TextUtils.isEmpty(holidayName)) {
            String lunarDate = new com.shixi.shixitraining.shixitraining.util.LunarDayUtil(calendar).toLunarFormatDay();
