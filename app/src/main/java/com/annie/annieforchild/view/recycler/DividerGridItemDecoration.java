...
/**
 *
 * 分割线GridLayoutManager、StaggeredGridLayoutManager
 */
...
//            final int right = left + mDivider.getIntrinsicWidth();
                              ...
                              int childCount)
    {
        ...
        if (layoutManager instanceof GridLayoutManager)
        {
            if(childCount%spanCount==0){
                int colum = childCount / spanCount;
                int comparePosition = (colum - 1)*spanCount;
                if(pos>=comparePosition){
                    return true;
                }
            }else{
                childCount = childCount - childCount % spanCount;
                               ...
                               RecyclerView parent)
    {
        ...
        if(isLastRaw(parent, itemPosition, spanCount, childCount)&&
                isLastColum(parent, itemPosition, spanCount, childCount)){//最后一行,最后一列
            outRect.set(0,0,0,0);
