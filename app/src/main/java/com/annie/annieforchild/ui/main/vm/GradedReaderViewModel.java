...
public class GradedReaderViewModel  extends BaseViewModel<DemoRepository> {
    public ObservableField<String> image=new ObservableField<>();
    public   ObservableField<String> title=new ObservableField<>();
    public ObservableField<String> bookNumber=new ObservableField<>();

    public GradedReaderViewModel(@NonNull Application application, DemoRepository model) {
