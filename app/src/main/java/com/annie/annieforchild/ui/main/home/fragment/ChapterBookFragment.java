...
import com.annie.annieforchild.databinding.FragmentChapterBookBinding;
...
public class ChapterBookFragment  extends BaseFragment<FragmentChapterBookBinding, ChapterBookViewModel> {
    public ViewModelProvider viewModelProvider;
    @Override
    public int initContentView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        return R.layout.fragment_chapter_book;
    }
    ...
    public void initViewObservable() {
        ...
        binding.chapterBookRcview.setLayoutManager(manager);
    }


    @Override
    public ChapterBookViewModel initViewModel() {
        AppViewModelFactory factory = AppViewModelFactory.destroyInstance(getActivity().getApplication());
        return ViewModelProviders.of(this,factory).get(ChapterBookViewModel.class);
    }
...
//        binding.chapterBookRcview.setAdapter(adapter);
