...
public class DensityUtil {
    ...
    public static int getAdjustSize(int srcSize, float srcDensity) {
        double d = getDensity(BaseApplication.sAndroidApp) * 160;
    ...
    public static int dp2px(double dpVal) {
        if (dpVal == 0) {
            ...
            int px = dp2px(BaseApplication.sAndroidApp, (float) dpVal);
            if (px <= 1) {
                return 1;
            } else {
                return px;
    ...
    public static int sp2px(float sp) {
        return sp2px(BaseApplication.sAndroidApp, sp);
    }
    ...
    public static float px2dp(float pxValue) {
        return px2dp(BaseApplication.sAndroidApp, pxValue);
    }
    ...
    public static int screenWidth() {
        ...
        WindowManager windowManager = (WindowManager) BaseApplication.sAndroidApp.getSystemService(Context.WINDOW_SERVICE);
